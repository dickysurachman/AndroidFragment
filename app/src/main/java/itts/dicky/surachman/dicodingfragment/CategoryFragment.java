 ...
 */public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_home2fragment, container, false);
        View view = inflater.inflate(R.layout.fragment_category, container, false);
        // Inflate the layout for this fragment
        //return inflater.inflate(R.layout.fragment_home2, container, false);
        Button button=view.findViewById(R.id.btn_detail_category);
            ...
            public void onClick(View v) {
                if (v.getId() == R.id.btn_detail_category) {
                    ...
                    if (mFragmentManager != null) {
                        mFragmentManager
                                .beginTransaction()
                                .replace(R.id.frame_container1, mDetailCategoryFragment, DetailCategoryFragment.class.getSimpleName())
                                .addToBackStack(null)
                                .commit();
                    }
                }
